...
def test_pp_huawei_vrp_interface_speed_mode_1() -> None:
...
def test_pp_huawei_vrp_interface_speed_mode_2() -> None:
    current_config = dedent(
        """
        interface 25GE1/0/1
         description interface under test
...
def test_pp_huawei_vrp_interface_speed_mode_3() -> None:
    current_config = dedent(
        """
        interface 25GE1/0/1
         description interface under test
...
def test_pp_huawei_vrp_interface_speed_mode_4() -> None:
    current_config = dedent(
        """
        interface 25GE1/0/1
         description interface under test
