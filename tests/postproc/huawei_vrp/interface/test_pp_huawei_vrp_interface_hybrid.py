...
from ctreepo.postproc.huawei_vrp import HuaweiVRPInterfaceUnrangeVlans


def test_pp_huawei_vrp_interface_hybrid() -> None:
    ...
    diff = CTreeDiffer.diff(current, target, post_proc_rules=[HuaweiVRPInterfaceUnrangeVlans])
