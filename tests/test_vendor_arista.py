...
def test_to_dict(root: CTree) -> None:
    dst = {
        ...
        "children": {
            ...
            "hostname arista-switch": {"line": "hostname arista-switch", "tags": [], "template": "", "children": {}},
            "interface Ethernet1": {
            ...
            "management ssh": {
                ...
                "template": "",
                "children": {
                    "idle-timeout 30": {"line": "idle-timeout 30", "tags": ["mgmt"], "template": "", "children": {}},
                    "shutdown": {"line": "shutdown", "tags": ["mgmt"], "template": "", "children": {}},
                    "vrf MGMT": {
                        "line": "vrf MGMT",
                        "tags": ["mgmt"],
                        "template": "",
                        "children": {
                            "no shutdown": {"line": "no shutdown", "tags": ["mgmt"], "template": "", "children": {}}
                        },
                    },
                },
            },
